...
use PhalconRest\Exceptions\UnexpectedValueException;
use PhalconRest\Exceptions\DomainException;
...
class JWT
{
     ...
     */
    private function sign($msg, $method = 'HS256')
    {
        $methods = array(
            'HS256' => 'sha256',
            'HS384' => 'sha384',
        ...
        return hash_hmac($methods[$method], $msg, $this->key, true);
    }
